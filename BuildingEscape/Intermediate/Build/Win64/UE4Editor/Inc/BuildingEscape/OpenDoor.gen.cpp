...
// End Cross Module References
	UFunction* Z_Construct_UDelegateFunction_BuildingEscape_OnOpenRequest__DelegateSignature()
	{
		...
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("OnOpenRequest__DelegateSignature"), RF_Public|RF_Transient|RF_MarkAsNative) UDelegateFunction(FObjectInitializer(), nullptr, (EFunctionFlags)0x00130000, 65535);
			ReturnFunction->Bind();
	...
	IMPLEMENT_CLASS(UOpenDoor, 931587621);
